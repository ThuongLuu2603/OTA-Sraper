...
hero_class = {"Agoda": "hero-agoda", "Trip.com": "hero-tripcom", "Mytour.vn": "hero-mytour"}[ota_name]
ota_class  = {"Agoda": "ota-agoda",  "Trip.com": "ota-tripcom",  "Mytour.vn": "ota-mytour"}[ota_name]

logo_map = {"Agoda": "🟠", "Trip.com": "🔵", "Mytour.vn": "🟢"}
st.markdown(f"""
...
if st.session_state.scrape_results:
    ...
    header_class = {"Agoda": "result-header-agoda", "Trip.com": "result-header-tripcom", "Mytour.vn": "result-header-mytour"}[ota_name]
    ...
    # ── Metrics ──
    price_col = {"Agoda": "Giá/đêm (chưa gồm thuế)", "Trip.com": "Giá/đêm (VND)", "Mytour.vn": "Giá/đêm (VND)"}[ota_name]
    m_cols = st.columns(5)
